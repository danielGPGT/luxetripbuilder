...
export default function MediaLibrary() {
  ...
  return (
    <TierRestriction feature="media_library" mode="overlay">
      <div className="p-6">
                            ...
                            <div className="p-4 h-full flex flex-col justify-between">
                                ...
                                <div className="text-white">
                                    ...
                                    <Button
                                        size="sm"
                                        variant="ghost"
                                        onClick={() => handleRegenerateTags(item.id)}
            ...
            <form onSubmit={(e) => {
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <SelectContent>
                        {['landscape', 'city', 'food', 'activity', 'accommodation', 'culture', 'nature', 'luxury', 'adventure', 'relaxation', 'entertainment', 'business', 'sports', 'events'].map(category => (
                        <SelectItem key={category} value={category}>
                            {category.charAt(0).toUpperCase() + category.slice(1)}
                        </SelectItem>
                        ))}
